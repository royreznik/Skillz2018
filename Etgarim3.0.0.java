 ...
 */
//-----------------------------------------------------------
// updated 90% of things to work with the new API, new methods, new tactic. #MarzukMasterRace
...
//        else if(this.pirate.canPush(myHelper())){
    ...
    {
        if(Engine.getEnemyCapsuler()!= null && Engine.getEnemyCapsuler().distance(game.getEnemyMotherships()[0]) < 5400)
        {
